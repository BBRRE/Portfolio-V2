    ...
    <div className={` font-inconsolata w-full overflow-hidden mt-[-100px] `}>
      ...
      >
        <div className="flex w-full mx-auto max-w-[1200px] flex-col px-4 md:px-6">
          ...
          <div 
            className="flex flex-col md:flex-row w-full mx-auto max-w-[1200px] h-auto cursor-pointer relative z-10" 
          ...
          <motion.div
            className={`w-full max-w-[1200px] mx-auto transition-all duration-1000 ease-in-out  ${isExpanded ? '' : 'h-auto'}
              ...
              `}
          >
            <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 p-4 md:p-8 justify-center ${isExpanded ? '' : 'h-auto'}`}>
              {/* Balcony Section */}
