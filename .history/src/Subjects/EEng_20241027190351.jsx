      ...
      >
        ...
        <div className="min-w-full min-h-screen flex relative">
          <div className="w-full h-screen mx-auto ">
            ...
            <div className="h-full w-[85%] mx-auto grid grid-cols-2 items-center justify-center">
            <motion.h1
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-5xl font-hubballi absolute top-6 left-16 text-gray-800"
          >
            MacroPad V2
          </motion.h1>
