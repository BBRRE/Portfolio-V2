    ...
    <div className='bg-[#B5C0B7] w-full h-screen grid grid-cols-1'>
      <div className='flex md:flex-row flex-col justify-center align-middle w-[85%] h-[500px] mx-auto mt-24'>
        ...
        <p className="text-gray-700 text-sm md:text-base leading-relaxed">
          ...
          and Firebase for the backend. It is still in development but I have linked a working prototype <a href="journey-3930f.web.app" className='underline'>journey-3930f.web.app</a>
        </p>
        </div>
      </div>
    </div>
