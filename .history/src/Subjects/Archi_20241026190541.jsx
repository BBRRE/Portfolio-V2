...
const Arcchi = () => {
  ...
  useEffect(() => {
    ...
    if (isExpanded) {setDelayedExpanded(true)
      ...
      timer = setTimeout(() => setDelayedExpanded(false), 500);
    }
              ...
              <div className="flex flex-col space-y-4 md:space-y-6">
                ...
                <div className="space-y-2 md:space-y-4 px-4 md:px-0">
                  ...
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                    ...
                    room. I decided to expand the kitchen out into teh living room and incorporate a large window to not only help with ventilation but 
                    to bring some natural light giving a more enjoyable cooking experience. I also removed many small storage rooms in teh kitchen and repurposed
                    it into one large laundry / storage room. This alleviates some stress off the kitchen, and as teh door is angled away from the kitchen you wouldn'<table>b</table> 
                  </p>
                </div>
              </div>
