    ...
    <div className="bg-gradient-to-br from-green-50 to-amber-50 w-screen min-h-screen">
      ...
      >
        ...
        <div className="min-w-full min-h-screen flex relative">
          ...
          <div className="w-[92%] md:w-[85%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-20 md:mt-24 relative">
            {/* Section 1 */}
            <motion.div
            ...
            <motion.img
              ...
              src={wiring}
              alt="wiring"
              className="rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 w-full col-start-1 row-start-2 md:col-start-2 md:row-start-2"
            />
            ...
            <motion.div
              ...
              className="my-auto space-y-4 md:col-start-1 md:row-start-2 col-start-2 row-start-2"
            >
              <div className="flex items-center gap-3">
