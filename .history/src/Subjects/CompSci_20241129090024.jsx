...
const CompSci = () => {
  return (
    <div className='bg-[#B5C0B7] w-full h-auto min-h-screen grid grid-cols-2'>
      <div className='relative flex md:flex-row flex-col justify-center align-middle mx-auto mt-24'>
        <img src={cs} />
        <div className="absolute left-0 bottom-2 flex flex-col ml-4 gap-3 justify-center">
