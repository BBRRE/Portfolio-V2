  ...
  return (
    <div className='bg-[#F9F7F0] bg-dot-pattern font-italiana w-full h-full '>
      <div className='flex flex-col pt-[100px] gap-8 w-full'>
        ...
        <div className={`flex w-full mx-auto max-w-[1200px] h-[80vh] relative
        `}
        onClick={() => {setIsExpanded(!isExpanded)}}
        >
          
          <img className={` object-cover rounded-sm duration-500 transition-all absolute
          ${isExpanded ? 'w-4/6' : 'w-full '}
          `}
           src={archi}
           />
          
          <div className={`w-2/6 pl-[20px] pt-[20px] my-auto transition-opacity duration-100
          ${isExpanded ? 'opacity-100' : 'opacity w-0'}
          `} >
