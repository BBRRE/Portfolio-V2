...
const Arcchi = () => {
  ...
  return (
    <div className='bg-[#F9F7F0] bg-dot-pattern flex flex-col gap-14'>
    <div className={` font-inconsolata w-full overflow-hidden `}>
      <motion.div 
      ...
      >
        <div className="flex w-full mx-auto max-w-[1200px] flex-col px-4 md:px-6">
          ...
          <div 
            className={`flex flex-col md:flex-row w-full mx-auto max-w-[1200px] h-[60vh] md:h-[80vh] cursor-pointer relative z-10  ${isExpanded ? '' : 'h-0'}`} 
