...
import { ChevronRight, ChevronLeft, Settings, Microchip } from 'lucide-react';
...
const EEng = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-amber-50 w-screen overflow-x-hidden min-h-screen font-hubballi">
      <motion.div 
