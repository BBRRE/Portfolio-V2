        ...
        <div className='flex flex-col pt-[100px] gap-8 w-full'>
          <div className='flex w-full px-4 mx-auto max-w-[1200px] h-[80vh]' >
            ...
            <div className='w-3/5 bg-[#d8d8d8] pl-[20px]' >
              <h1 className='text-xl font-bold' >Redesiging the layout of an apartment</h1>
              <p className='ml-[20px] mt-[15px]' > Uk tower block built in the 1960's where designed to reduce the 
