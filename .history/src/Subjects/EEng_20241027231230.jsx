...
const EEng = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-amber-50 w-full overflow-x-hidden">
      <motion.div
      ...
      >
        ...
        <div className="w-full relative">
          <motion.h1
            ...
            className="text-5xl font-hubballi pt-6 pl-8 text-gray-800"
          >
            MacroPad V1
          </motion.h1>

          <div className="w-[85%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-24 relative">
            {/* Section 1 */}
            <motion.div
          ...
          <motion.button
            ...
            animate={{ opacity: 1, x: 0 }}
            onClick={handleSlide}
            className="fixed md:absolute z-10 bottom-4 md:top-8 right-4 md:right-8 bg-amber-100 hover:bg-amber-200 duration-300 px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 group"
          >
            Next
        ...
        <div className="w-full relative">
          <div className="w-auto h-auto mx-auto">
            <motion.button
              ...
              animate={{ opacity: 1, x: 0 }}
              onClick={handleSlide}
              className="fixed md:absolute z-10 bottom-4 md:top-8 left-4 md:left-8 bg-amber-100 hover:bg-amber-200 duration-300 px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 group"
            >
              <ChevronLeft className="group-hover:-translate-x-1 transition-transform" />
              Back
            </motion.button>
            <div className="h-auto w-[85%] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-center mt-24">
              <motion.h1
                className="text-5xl font-hubballi pt-6 pl-8 md:pl-36 text-gray-800"
              >
                MacroPad V2
              </motion.h1>
              ...
              <motion.img
                src={Des3}
                alt="final"
                className="col-span-1 md:col-span-2 mx-auto mt-4 w-full mb-16"
              />
            </div>
          </div>
        </div>
