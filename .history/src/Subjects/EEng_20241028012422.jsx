...
const EEng = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-amber-50 w-screen min-h-screen">
      <motion.div
      ...
      >
        ...
        <div className="min-w-full min-h-screen flex relative">
          ...
          <div className="w-[92%] md:w-[85%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-x-8 mt-20 md:mt-24 relative items-center">
            {/* Section 1 */}
            <motion.div
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.2 }}
              className="space-y-4 row-start-1"
            >
            ...
            <motion.img
              ...
              src={schema}
              alt="schema"
              className="rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 w-full row-start-2"
            />
            ...
            <motion.div
              ...
              className="space-y-4 row-start-3"
            >
              <div className="flex items-center gap-3">
            ...
            <motion.img
              ...
              src={wiring}
              alt="wiring"
              className="rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 w-full row-start-4"
            />
            ...
            <motion.div
              ...
              className="space-y-4 row-start-5"
            >
              <div className="flex items-center gap-3">
            ...
            <motion.img
              ...
              src={final}
              alt="final"
              className="rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 w-full row-start-6"
            />
          </div>
          ...
          <motion.button
            ...
            animate={{ opacity: 1, x: 0 }}
            onClick={handleSlide}
            className="absolute right-4 md:right-8 top-8 bg-amber-100 hover:bg-amber-200 duration-300 px-4 md:px-6 py-2 md:py-3 rounded-lg shadow-lg flex items-center gap-2 group text-sm md:text-base"
          >
            Next
