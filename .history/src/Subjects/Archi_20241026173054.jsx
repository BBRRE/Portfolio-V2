...
const Arcchi = () => {
  ...
  return (
    <div className='bg-[#F9F7F0] bg-dot-pattern font-inconsolata w-full h-[120vh] '>
      <div className='flex flex-col pt-[100px] gap-8 w-full'>
        <div className='flex w-full mx-auto max-w-[1200px]  flex-col'>
          ...
          <div
            className={`bg-green-600 duration-500 w-full grid grid-cols-2 grid-rows-5 gap-4 overflow-hidden  ${isExpanded ? 'max-h-[5000px] p-4' : 'max-h-0'
              }`}
          >
            <img src={balcony} alt="" />
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores ducimus ipsam at. Sapiente commodi libero ad repellat explicabo tempore nisi vitae, quibusdam provident perferendis eaque ipsam mollitia quasi magnam asperiores?
            </p>

            <p>
Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ad ducimus necessitatibus nobis architecto sed eos itaque, magnam non ea amet reiciendis tempore. Odio iste culpa qui iure esse sed dolor?
            </p>
            <img src={kitchen} alt="" />

            <img src={bathroom} alt="" />
            <p>
Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi corrupti exercitationem voluptatibus nisi, quas hic, magni quidem voluptatum sint eveniet possimus unde ad, dicta itaque! Explicabo eos tempora reprehenderit perferendis?
            </p>
