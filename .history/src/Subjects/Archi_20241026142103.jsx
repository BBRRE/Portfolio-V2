...
const Arcchi = () => {
    ...
    const handleSlideChange = (newIndex) => {
      ...
      setTimeout(() => {
        ...
        // Start fading in new text as image transitions
        setTimeout(() => {
          setTextVisible(true);
        }, 300);
          ...
          <div className='bg-slate-200 max-w-[1200px] mx-auto'>
            <div className='flex w-full mx-auto max-w-[1200px] h-[80vh]'>
              ...
              <div className='w-3/5 pl-[20px] pt-[20px] my-auto'>
                ...
                <p className='ml-[20px] my-[15px] font-inconsolata'>
                ...
                <div className="relative w-full h-96 overflow-hidden rounded-lg">
                  ...
                  <div className="absolute inset-0 w-full h-full">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                      <div className={`transform transition-all duration-300 ${textVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
