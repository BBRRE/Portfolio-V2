          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 p-4 md:p-8 justify-center">
              ...
              <img 
                  src={logronyo4} 
                  alt="Balcony view" 
                  className="w-full max-w-[400px] h-auto object-cover rounded-lg shadow-lg mx-auto col-span-2"
                />
                <img 
                  src={logronyo1} 
                  alt="Bathroom design" 
                  className="w-full max-w-[400px] h-auto object-cover rounded-lg shadow-lg mx-aut col-span-2 mx-auto"
                />
            </div>
          </motion.div>
        </div>
