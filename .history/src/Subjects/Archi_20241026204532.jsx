...
const Arcchi = () => {
  ...
  return (
    <motion.div className={`bg-[#F9F7F0] bg-dot-pattern font-inconsolata w-full min-h-screen overflow-hidden ${isExpanded ? '' : 'h-screen '} `}
    initial='y: 10000px'
    animate=''
    transition={1000}
    >
        ...
        <div className="flex w-full mx-auto max-w-[1200px] flex-col px-4 md:px-6">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 p-4 md:p-8 justify-center">
              ...
              <img 
                src={newL} 
                className="col-span-1 md:col-span-2 mt-8 md:mt-[200px] w-full max-w-[1200px] mb-[100px] mx-auto rounded-lg shadow-lg" 
                alt="New Layout"
              />
            </div>
          </motion.div>
