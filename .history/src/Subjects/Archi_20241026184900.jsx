...
const Arcchi = () => {
  ...
  return (
    <div className={`bg-[#F9F7F0] bg-dot-pattern font-inconsolata w-full min-h-screen flex flex-col ... ${isExpanded ? 'pb-16' : ''}`}>
        ...
        <div className="flex w-full mx-auto max-w-[1200px] flex-col px-4 md:px-6">
          ...
          <motion.div
            className={`w-full max-w-[1200px] mx-auto transition-all duration-1000 ease-in-out
              ${delayedExpanded ? 'opacity-100 mt-[-200px] md:mt-8' : 'opacity-0 mt-[-400px] h-0 hidden'}`}
          >
