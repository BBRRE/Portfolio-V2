...
const Arcchi = () => {
  ...
  return (
    ...
    <div className={`bg-[#F9F7F0] bg-dot-pattern font-inconsolata w-full min-h-screen overflow-hidden ${isExpanded ? '' : 'h-screen '} `}>
      <motion.div 
    ...
    <div className={`bg-[#F9F7F0] bg-dot-pattern font-inconsolata w-full min-h-screen overflow-hidden ${isExpanded2 ? '' : 'h-screen '} `}>
      <motion.div 
        className="flex flex-col pt-[60px] md:pt-[100px] gap-4 md:gap-8 w-full"
        initial="hidden"
        animate="visible"
      ...
      >
        <div className="flex w-full mx-auto max-w-[1200px] flex-col px-4 md:px-6">
          ...
          <div 
            className="flex flex-col md:flex-row w-full mx-auto max-w-[1200px] h-[60vh] md:h-[80vh] cursor-pointer relative z-10" 
            onClick={() => setIsExpanded(!isExpanded2)}
          >
            {/* Mobile Image */}
