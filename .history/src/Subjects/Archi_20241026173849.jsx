...
>
  <img src={balcony} alt="" className="p-4" />
  
  <div className="p-4">
    <h1 className='text-xl font-inconsolata'>Redesigning the layout of an apartment</h1>
    <p className='font-inconsolata'>
      UK tower block built in the 1960s designed to reduce the post-war housing shortage. Many of these structures embraced a brutalist architectural style...
    </p>
  </div>
  ...
  <img src={kitchen} alt="" className="p-4" />
  <img src={bathroom} alt="" className="p-4" />
