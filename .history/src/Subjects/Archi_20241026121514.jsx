...
const Arcchi = () => {
  return (
    <div className='bg-[#7e7d7b] font-italiana w-full h-screen '>
        <div className='flex flex-col pt-[100px] gap-8 w-full'>
          <div className='flex w-full px-4 mx-auto max-w-[1200px] h-[80vh] bg-[#9f9f9f]' >
            <img className='w-full object-cover ' src={archi}/>
            <div className='w-3/5 pl-[20px] pt-[20px]' >
