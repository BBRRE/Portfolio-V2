...
const MacroPadShowcase = () => {
  ...
  const images = {
    schema: '../assets/Schematics.png',
    wiring: '../assets/pcb.png',
    final: '../assets/Final - copy.png',
    model: '../assets/model.png',
    inspo: '../assets/Inspo (1).png',
    des1: '../assets/Des1.png',
    des2: '../assets/Des2.png',
    des3: '../assets/Des3.png'
  };
