        ...
        <div className="min-w-full h-screen flex relative">
          ...
          <div className="w-[80%] mx-auto grid grid-cols-2 gap-4 mt-10 relative">
            <div className='my-auto'>
              ...
              <p className='text-gray-700 text-sm md:text-base'>The choice of components was made largley by what I already had, this included the Pi Pico, 9 mechanical switches and the 3 state switch. I then decided to buy 3 rotary encoders.
            ...
            <div>
              <h1>Firmware and Final Touches</h1>
              <p>
