              ...
              <div className="flex flex-col space-y-4 md:space-y-6">
                <div className="h-auto md:h-[400px] bg-white rounded-lg shadow-lg p-4 md:p-6 md:mt-[450px]">
                  ...
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base ">
                    ...
                    removing and building walls so the apartmentlayout would fit a more modern style. The floor plans where made in Autocad, and the full revamped floor plan is below.
                  </p>
                </div>
              </div>
