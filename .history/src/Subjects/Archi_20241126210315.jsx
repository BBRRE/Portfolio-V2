        ...
        <div className="flex w-full mx-auto max-w-[1200px] flex-col px-4 md:px-6">
          ...
          >
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed text-sm md:text-base z-10">
              Designed as an entry to a compititon ran by Concéntrico for an urban climate island. The entries are evaluted on sustainability, feasibility, versatility and integration 
