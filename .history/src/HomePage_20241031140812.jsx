  ...
  return (
    <div className='h-screen w-full overflow-y-scroll snap-y snap-mandatory'>
      <div className='snap-start'>
        <div className='flex flex-col w-full h-screen bg-noise snap-center relative overflow-hidden'>
          <img 
            src={wrd} 
            alt="Background wave" 
            className='absolute scale-x-[-1] opacity-20 md:opacity-100 -right-1/4 md:right-0 top-0 w-full md:w-auto' 
          />
