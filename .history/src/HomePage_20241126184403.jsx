  ...
  return (
    <div className='h-screen w-full overflow-y-scroll snap-y snap-mandatory '>
      <div className='snap-start'>
        <div className='flex flex-col w-full h-screen snap-center relative overflow-hidden bg-[#343434] text-[#bddfbd]'>
          <img 
            src={wrd} 
            alt="Background wave" 
            className='absolute scale-x-[-1]  md:right-0 top-0 w-full -z-10 md:w-auto' 
          />
