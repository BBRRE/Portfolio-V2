...
const projects = [
    { image: archi, title: "Architecture", font: 'italiana', color: '#F9F7F0' },
    { image: eeng, title: "Electronic Eng", font: 'hubballi', color: '#e5fbe8' },
    { image: compsci, title: "Computer Sci", font: 'julius', color: '#B5C0B7' },
    { image: other, title: "Other", font: 'inconsolata', color: '#F7F0D7' },
];
...
const ProjectsOverview = () => {
    ...
    return (
        <div className="flex flex-col w-full h-[100vh] bg-[#343434] snap-center overflow-hidden">
